...
def sampler_object(
    name: str, pipeline: bool = False, extra_options: dict = {}
) -> KSAMPLER:
    ...
    #### Args:
        ...
        - `pipeline` (bool, optional): Whether to use the pipeline. Defaults to False.
        - `extra_options` (dict, optional): Extra options for the sampler. Defaults to {}.

    #### Returns:
        - `KSAMPLER`: The KSAMPLER object.
    """
    sampler = ksampler(name, pipeline=pipeline, extra_options=extra_options)
    return sampler
